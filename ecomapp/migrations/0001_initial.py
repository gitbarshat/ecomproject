    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('order_status', models.CharField(choices=[('order received', 'order received'), ('order processing', 'order processing'), ('order completed', 'order completed'), ('order on the way', 'order on the way'), ('order cancelled', 'order cancelled')], max_length=50)),
